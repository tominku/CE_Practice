...
set terminal GNUTERM size 600,400
set encoding utf8

#==============================================================================
# SETUP COMMANDS
#==============================================================================
set xlabel 'Position (nm)' enhanced textcolor '#404040'
set ylabel 'log(max residual)' enhanced textcolor '#404040'

set border 3 front linetype 1 linewidth 2 linecolor '#404040'
set grid back linetype 1 linewidth 1 linecolor '#d6d7d9' dashtype 0
...
unset rtics
unset mrtics
set key bmargin center opaque horizontal Left noinvert reverse width 2 height 1 samplen 4 spacing 1 enhanced textcolor '#404040' nobox maxrows auto maxcols auto
...
#==============================================================================
plot \
    'plot48.dat' index 0 with lines linestyle 1 linewidth 2, \
    'plot48.dat' index 1 with points linestyle 2 linewidth 2 pointtype 6
