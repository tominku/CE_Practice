...
const string subject_name = "NP_PN_2D_v4";
...
int main() {    
    ...
    {        
        ...
        std::string n_file_name = fmt::format("{}_eDensity_B_{:.2f}.csv", subject_name, (0.1*i));
        ...
        std::string h_file_name = fmt::format("{}_holeDensity_B_{:.2f}.csv", subject_name, (0.1*i));
        holeDensity.save(h_file_name, csv_ascii);        
        
        vec phi_for_plot = phi(span(1, N));
        std::string phi_file_name = fmt::format("{}_phi_B_{:.2f}.csv", subject_name, (0.1*i));
