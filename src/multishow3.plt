...
set ylabel 'log (delta phi)' enhanced textcolor '#404040'
...
#==============================================================================
plot \
    'plot3.dat' index 0 with lines linestyle 1 linewidth 2, \
    'plot3.dat' index 1 with points linestyle 2 linewidth 2 pointtype 6
